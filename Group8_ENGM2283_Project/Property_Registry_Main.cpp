...
int main(void) {
	...
	cout << "Enter R to retrieve property by address" << endl;// im curious about how to search through, what is the search condition?
	cout << "Enter S to sort properties by [square feet]" << endl; //we just need to choose a sort condition
